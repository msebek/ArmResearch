classdef KalmanFilterSE3 < handle
    ...
    methods
        ...
        function [obj] = KalmanFilterSE3( varargin )
            ...
            KalmanFilterSE3.CheckX( x0 );
            KalmanFilterSE3.CheckS( S0 );
            KalmanFilterSE3.CheckMode( m );
        ...
        function [] = SetMode( obj, mode )
            KalmanFilterSE3.CheckMode( mode );
            m = strcmp( mode, 'left' );
            if m == obj.leftMode
                return
            end
        ...
        function [] = Predict( obj, varargin )
            ...
            KalmanFilterSE3.CheckX( d );
            KalmanFilterSE3.CheckS( Q );
            KalmanFilterSE3.CheckMode( dM );
            KalmanFilterSE3.CheckMode( QM );
        ...
        %   Update( z, R, RMode )
        function [innovation, C, residual, Cv] = Update( obj, varargin )
            ...
            KalmanFilterSE3.CheckX(z);
            KalmanFilterSE3.CheckS(R);
            KalmanFilterSE3.CheckMode(RM);
            ...
            poseErr = z/xt;
            residual = poseErr.GetCoordinates();
            Cv = St;
        end
