...
% the log of the hyperparameters and x is an n by D matrix of cases, where
...
%
% 5) With four input arguments and a single output:
%
%     D = covNAME(logtheta, x, z, u)
%
% The function computes and returns the n by n matrix of partial derivatives
% of the testxtraining set covariance matrix with respect to logtheta(z), ie with
% respect to the log of hyperparameter number u.
%
...
% modified by Kristian Kersting, 2007.
