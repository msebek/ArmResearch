function [out1, out2] = mlhgpr(logtheta, covfunc, x, y, xstar);
...
%
% Kristian Kersting, 2007: adapted well actually simply copied from 
...
alpha = solve_chol(L',y); % solves L'*alpha=y also eigentlich K*alpha=y
